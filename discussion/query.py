...
class Query(object):
    discussions = graphene.Field(PaginatedDiscussionList, offset=graphene.Int(), limit=graphene.Int())
    ...
    def resolve_discussions(self, info, offset=0, limit=20):
        return PaginatedDiscussionList(
            ...
            edges=Discussion.objects.visible(info.context.user)[offset:(offset+limit)]
        )
