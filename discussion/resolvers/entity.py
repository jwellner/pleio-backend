...
discussion.set_field("tagCategories", shared.resolve_entity_categories)
...
discussion.set_field("scheduleArchiveEntity", shared.resolve_entity_schedule_archive_entity)
discussion.set_field("scheduleDeleteEntity", shared.resolve_entity_schedule_delete_entity)
discussion.set_field("status", shared.resolve_entity_status)
