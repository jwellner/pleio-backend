...
class StatusUpdateTestCase(FastTenantTestCase):
    ...
    def test_status_update_anonymous(self):
        ...
        self.assertEqual(data["entity"]["timeCreated"], self.statusPublic.created_at.isoformat())
    ...
    def test_status_update_private(self):
        ...
        self.assertEqual(data["entity"]["timeCreated"], self.statusPrivate.created_at.isoformat())
        self.assertEqual(data["entity"]["tags"], [])
        self.assertEqual(data["entity"]["tags"], [])
        self.assertEqual(data["entity"]["views"], 1)
        self.assertEqual(data["entity"]["votes"], 0)
