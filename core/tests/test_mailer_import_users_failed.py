...
from core.mail_builders.user_import_failed_mailer import UserImportFailedMailer
...
class TestMailerImportUsersFailedTestCase(PleioTenantTestCase):
    ...
    def setUp(self):
        ...
        self.mailer = UserImportFailedMailer(user=self.operating_user.guid,
                                             stats=self.STATS,
    ...
    def test_mailer_properties(self, mocked_build_context):
        ...
        self.assertEqual(self.mailer.get_template(), 'email/user_import_failed.html')
        ...
        self.assertEqual(self.mailer.get_subject(), "Import failed")
