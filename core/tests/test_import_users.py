...
class ImportUsersTestCase(FastTenantTestCase):
    ...
    def test_import_users_step1_admin(self):
        ...
        self.assertEqual(data["importUsersStep1"]["csvColumns"], ["column1", "column2", "column3", 'column4', 'column5'])
        self.assertEqual(data["importUsersStep1"]["userFields"][3]["label"], self.profileField1.name)
    ...
    def test_import_users_step2_admin_new_users(self, mocked_import_users):
        ...
        self.assertEqual(data["importUsersStep2"]["success"], True)

        # call import task synchronous
        task = import_users.s(connection.schema_name, fields, self.usersCsv, self.admin.guid).apply()
    ...
    def test_import_users_step2_admin_invalid_user_field(self):
        ...
        self.assertEqual(errors[0]["message"], "invalid_user_field")
    ...
    def test_import_users_step2_admin_invalid_access_id(self):
        ...
        self.assertEqual(errors[0]["message"], "invalid_access_id")

    @patch('core.tasks.send_mail_multi.delay')
    def test_import_user_step2_success_mail(self, mocked_send_mail_multi):
        ...
        self.assertTrue('email/user_import_success.html' in args)
    ...
    def test_import_user_step2_error_mail(self, mocked_send_mail_multi):
        ...
        args, kwargs = mocked_send_mail_multi.call_args
        mocked_send_mail_multi.assert_called_once()
        self.assertTrue('email/user_import_failed.html' in args)