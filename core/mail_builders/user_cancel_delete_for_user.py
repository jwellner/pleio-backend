...
def schedule_user_cancel_delete_for_user_mail(user):
    from core.models import MailInstance
    MailInstance.objects.submit(UserCancelDeleteToSelfMailer,
                                mailer_kwargs={
                                    "user": user.guid,
                                })


class UserCancelDeleteToSelfMailer(TemplateMailerBase):
    ...
    def get_template(self):
        return 'email/toggle_request_delete_user_cancelled.html'
