...
class QuestionTestCase(FastTenantTestCase):
    ...
    def test_question_anonymous(self):
        ...
        self.assertEqual(data["entity"]["timeCreated"], self.questionPublic.created_at.isoformat())
    ...
    def test_question_owner(self):
        ...
        self.assertEqual(data["entity"]["timeCreated"], self.questionPrivate.created_at.isoformat())
